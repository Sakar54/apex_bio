...
def export_to_csv(modeladmin, request, queryset):
    ...
    writer.writerow(["First Name", "Last Name", "Email", "Phone", "Company", "Country", "Job Title", "Job Details"])
    for contact in queryset:
        writer.writerow([contact.first_name, contact.last_name, contact.email, contact.phone, contact.company, contact.country, contact.job_title, contact.job_details])
    return response

@admin.register(Contact)
class ContactAdmin(admin.ModelAdmin):
    list_display = ("first_name", "last_name", "email", "phone", "company", "country", "job_title", "graph_link")
    list_filter = ("country", "company")
    search_fields = ("first_name", "last_name", "email", "phone", "company", "job_title")
    ...
    def graph_link(self, obj):
        return format_html('<a href="{}">View Graph</a>', "graph/")
